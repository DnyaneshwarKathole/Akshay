...
public class KiteTest {
	...
	public void loginToApp() {
		...
		login1.setUNKiteLoginPage(sheet.getRow(0).getCell(0).getStringCellValue());
		
		login1.setPwdKiteLoginPage(sheet.getRow(0).getCell(1).getStringCellValue());
		
		login1.clickLoginKiteLoginPage();
	
		login2.setPinKiteLogin2Page(sheet.getRow(0).getCell(2).getStringCellValue());
